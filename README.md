...
Go to: https://openai.com/product and sign up for a free account. You can get a free trial, and get your API key
and that should be enough for what you need during development. They have a user dashboard that provides all the information you need and allows you to track quota usage.
